...
describe('Others', () => {
    ...
    it('Wikipedia', (done) => {
        (0, index_1.wikipedia)('Minecraft', 'en').then(res => {
    ...
    describe('Jadwal TV', () => {
        it('Jadwal TV', done => {
            (0, index_1.jadwalTV)('RCTI').then(res => {
                (0, chai_1.expect)(res).to.be.an('object');
        ...
        it('Jadwal TV NOW', done => {
            (0, index_1.jadwalTVNow)().then(res => {
                (0, chai_1.expect)(res).to.be.an('object');
    ...
    describe('Mediafire', () => {
        it('Mediafire Download', done => {
            (0, index_1.mediafiredl)('https://www.mediafire.com/file/gpeiucmm1xo6ln0/hello_world.mp4/file').then(res => {
                (0, chai_1.expect)(res).to.be.an('object');
    ...
    describe('Lyrics', () => {
        it('Lyrics', done => {
            (0, index_1.lyrics)('rick astley never gonna give you up').then(res => {
                (0, chai_1.expect)(res).to.be.an('object');
                (0, chai_1.expect)(res.title).to.be.a('string');
